...
actor UpdateChecker {
    ...
    func check() async -> Result {
        guard let apiURL = URL(string: "https://api.github.com/repos/sevmorris/JustIn/releases/latest") else {
        ...
        do {
            ...
            guard let releaseURL = URL(string: release.htmlUrl)
                    ?? URL(string: "https://github.com/sevmorris/JustIn/releases") else {
...
func checkForUpdates(silent: Bool = false) async {
    ...
    case .upToDate(let version):
        ...
        alert.informativeText = "JustIn \(version) is the latest version."
    ...
    case .available(let version, let downloadURL, let releaseURL):
        ...
        alert.informativeText = "JustIn \(version) is available."
